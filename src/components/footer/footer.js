            ...
            <div className="container">
                ...
                <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top" bis_skin_checked="1">
                    ...
                    <ul className="list-unstyled d-flex">
                        <li className="ms-3"><a className="link-body-emphasis" href="#">tw</a></li>
                        <li className="ms-3"><a className="link-body-emphasis" href="#">in</a></li>
                        <li className="ms-3"><a className="link-body-emphasis" href="#">fb</a></li>
                    </ul>
                </div>
